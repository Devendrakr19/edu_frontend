      ...
      <div className="pt-[50px]">
        <Grid container rowGap={3}>
          ...
          <Grid item xs={12} md={6}>
            <div className="bg-[#1a7676] rounded-l rounded-full flex justify-start pr-[30px]">
          ...
          <Grid item xs={12} md={6}>
            <div className="px-[40px]">
              ...
              {card.map((data, index) => (
                <div
                  key={index}
                  className="w-[400px] border-[1px] hover:border-[transparent] border-[#1a7676b2] pt-[5px] pb-[10px] px-[8px] mt-[15px] rounded-lg  hover:shadow-xl transition duration-300 ease-in-out"
                >
