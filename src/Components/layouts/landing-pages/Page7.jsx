...
const Page7 = () => {
  return (
    <>
      <section className="h-[350px] bg-[#1a7676]">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="text-white absolute end-2.5 bottom-[9px] 
                          ...
                          bg-[#1a7676] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-semibold rounded-full text-sm px-6 py-3 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                >
                  Join now
                </button>
              </div>
